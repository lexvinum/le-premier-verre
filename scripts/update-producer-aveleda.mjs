...
const id = "producer-aveleda";

const producer = await client.getDocument(id);

if (!producer) {
  throw new Error("Le producteur Aveleda est introuvable.");
}
...
console.log("✓ Aveleda enrichi");
console.log("✓ Bio, approche et cépages signatures ajoutés");
console.log("✓ Informations de visite ajoutées");
console.log("✓ SEO et résumé IA ajoutés");
console.log("✓ Photo principale à ajouter manuellement dans Studio");
